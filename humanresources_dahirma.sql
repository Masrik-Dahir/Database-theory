...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="js/vendor/codemirror/lib/codemirror.css?v=5.1.3-2.el8.remi">
    <link rel="stylesheet" type="text/css" href="js/vendor/codemirror/addon/hint/show-hint.css?v=5.1.3-2.el8.remi">
    <link rel="stylesheet" type="text/css" href="js/vendor/codemirror/addon/lint/lint.css?v=5.1.3-2.el8.remi">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3-2.el8.remi&nocache=3384282471ltr&server=1">
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/printview.css?v=5.1.3-2.el8.remi" media="print" id="printcss">
    <title>cmsc508.com / localhost | phpMyAdmin 5.1.3-2.el8.remi</title>
    <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery.min.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery-migrate.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/sprintf.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/ajax.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/keyhandler.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/bootstrap/bootstrap.bundle.min.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery-ui.min.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/js.cookie.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery.mousewheel.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery.validate.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery-ui-timepicker-addon.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery.ba-hashchange-2.0.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/jquery/jquery.debounce-1.0.6.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/menu_resizer.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/cross_framing_protection.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/rte.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/messages.php?l=en&v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/config.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/doclinks.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/functions.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/navigation.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/indexes.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/common.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/page_settings.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/export_output.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/codemirror/lib/codemirror.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/codemirror/mode/sql/sql.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/codemirror/addon/runmode/runmode.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/codemirror/addon/hint/show-hint.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/codemirror/addon/hint/sql-hint.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/codemirror/addon/lint/lint.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/codemirror/addon/lint/sql-lint.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/vendor/tracekit.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/error_report.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/drag_drop_import.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/shortcuts_handler.js?v=5.1.3-2.el8.remi"></script>
  <script data-cfasync="false" type="text/javascript" src="js/dist/console.js?v=5.1.3-2.el8.remi"></script>

<script data-cfasync="false" type="text/javascript">
// <![CDATA[
CommonParams.setAll({common_query:"",opendb_url:"index.php?route=/database/structure",lang:"en",server:"1",table:"",db:"",token:"706571575b407a445a2a333b6a6f7d5c",text_dir:"ltr",show_databases_navigation_as_tree:true,pma_text_default_tab:"Browse",pma_text_left_default_tab:"Structure",pma_text_left_default_tab2:false,LimitChars:"50",pftext:"",confirm:true,LoginCookieValidity:"1440",session_gc_maxlifetime:"1440",logged_in:true,is_https:false,rootPath:"/phpMyAdmin/",arg_separator:"&",PMA_VERSION:"5.1.3-2.el8.remi",auth_type:"cookie",user:"dahirma"});
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=humanresources_dahirma&table=employees">`humanresources_dahirma`.`employees`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=humanresources_dahirma&table=locations">`humanresources_dahirma`.`locations`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=humanresources_dahirma&table=jobs">`humanresources_dahirma`.`jobs`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=humanresources_dahirma&table=countries">`humanresources_dahirma`.`countries`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=humanresources_dahirma&table=departments">`humanresources_dahirma`.`departments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_dahirma&table=ship">`project_dahirma`.`ship`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_dahirma&table=enemy">`project_dahirma`.`enemy`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_dahirma&table=ship_military">`project_dahirma`.`ship_military`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_dahirma&table=relates">`project_dahirma`.`relates`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=project_dahirma&table=ship_civilian">`project_dahirma`.`ship_civilian`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  <ul>
    <li class="first new_database italics"><div class='block'><i class='first'></i></div><div class="block second"><a href='index.php?route=/server/databases&server=1'><img src="themes/dot.gif" title="" alt="" class="icon ic_b_newdb"></a></div><a class='hover_show_full' href='index.php?route=/server/databases&server=1' title='New'>New</a><div class="clearfloat"></div></li><li class="database"><div class='block'><i></i><b></b><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.aHVtYW5yZXNvdXJjZXNfZGFoaXJtYQ==" data-vpath="cm9vdA==.aHVtYW5yZXNvdXJjZXNfZGFoaXJtYQ==" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=humanresources_dahirma&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=humanresources_dahirma' title='Structure'>humanresources_dahirma</a><div class="clearfloat"></div></li><li class="last database"><div class='block'><i></i><a class="expander" href='#'><span class="hide paths_nav" data-apath="cm9vdA==.cHJvamVjdF9kYWhpcm1h" data-vpath="cm9vdA==.cHJvamVjdF9kYWhpcm1h" data-pos="0"></span><img src="themes/dot.gif" title="Expand/Collapse" alt="Expand/Collapse" class="icon ic_b_plus"></a></div><div class="block second"><a href='index.php?route=/database/operations&amp;server=1&amp;db=project_dahirma&amp;'><img src="themes/dot.gif" title="Database operations" alt="Database operations" class="icon ic_s_db"></a></div><a class='hover_show_full' href='index.php?route=/database/structure&server=1&amp;db=project_dahirma' title='Structure'>project_dahirma</a><div class="clearfloat"></div></li>
  </ul>
</div>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="706571575b407a445a2a333b6a6f7d5c">
...
<p>index.php: Missing parameter: what<a href="./doc/html/faq.html#faqmissingparameters" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a><br>index.php: Missing parameter: export_type<a href="./doc/html/faq.html#faqmissingparameters" target="documentation"><img src="themes/dot.gif" title="Documentation" alt="Documentation" class="icon ic_b_help"></a><br></p>
  ...
  <div class="clearfloat" id="pma_errors">
    <div class="alert alert-danger" role="alert"><strong>Warning</strong> in ./libraries/classes/Plugins/Export/ExportSql.php#1754<br>
<img src="themes/dot.gif" title="" alt="" class="icon ic_s_error"> Attempt to read property &quot;isConstraint&quot; on array<br>
<br>
<strong>Backtrace</strong><br>
<br>
ExportSql.php#2215: PhpMyAdmin\Plugins\Export\ExportSql->getTableDef(<br>
	string &#039;humanresources_dahirma&#039;,<br>
	string &#039;emp_details_view&#039;,<br>
	string &#039;
&#039;,<br>
	string &#039;index.php?route=/database/export&amp;db=humanresources_dahirma&#039;,<br>
	boolean true,<br>
	boolean true,<br>
	boolean true,<br>
	boolean true,<br>
...
Export.php#902: PhpMyAdmin\Plugins\Export\ExportSql->exportStructure(<br>
	string &#039;humanresources_dahirma&#039;,<br>
	string &#039;emp_details_view&#039;,<br>
	string &#039;
&#039;,<br>
	string &#039;index.php?route=/database/export&amp;db=humanresources_dahirma&#039;,<br>
	string &#039;create_view&#039;,<br>
	string &#039;database&#039;,<br>
	boolean true,<br>
	boolean true,<br>
	boolean true,<br>
...
ExportController.php#549: PhpMyAdmin\Export->exportDatabase(<br>
	string &#039;humanresources_dahirma&#039;,<br>
	array,<br>
